...
export const CommunityCard = (props) => {
  const {
    name,
    location,
    period: { interval, day, weekDay },
    links: { twitter, facebook, website, meetUp, linkedIn },
    demographic,
    format,
  } = props.data;
  return (
